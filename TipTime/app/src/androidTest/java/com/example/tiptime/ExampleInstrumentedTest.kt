...
class CalculatorTests {
    ...
    fun calculate_20_percent_tip() {
        onView(withId(R.id.cost_of_service_text)).perform(typeText("50.00"))
    ...
    fun calculate_15_percent_tip() {
        ...
        onView(withId(R.id.cost_of_service_text)).perform(typeText("60.00"))
            .perform(closeSoftKeyboard())
    ...
    @Test
    fun calculate_rounded_tip() {
        onView(withId(R.id.cost_of_service_text)).perform(typeText("56.00"))
            .perform(closeSoftKeyboard())
